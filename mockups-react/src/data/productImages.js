// Product Images Data - High-quality images for marketplace products
export const productImages = {
  // Seeds Category - Organic Farming
  wheatSeeds: {
    id: 1,
    name: 'Organic Wheat Seeds - Premium',
  ...
  riceSeeds: {
    id: 3,
    name: 'Organic Basmati Rice Seeds',
  ...
  // Organic Pesticides - Natural Pest Control
  neemOil: {
    id: 6,
    name: 'Organic Neem Oil - Pure',
  ...
  steelPlow: {
    id: 8,
    name: 'Organic Farm Plow - Heavy Duty',
    image: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=400&h=300&fit=crop',
    category: 'Farm Tools',
  ...
  // Eco-Friendly Farm Equipment
  dripIrrigation: {
    id: 10,
    name: 'Organic Farm Drip Irrigation Kit',
  ...
  waterPump: {
    id: 11,
    name: 'Solar Water Pump for Organic Farm',
  ...
  // Organic Grains from Natural Farming
  basmatiRice: {
    id: 14,
  ...
  // Organic Spices from Natural Farms
  turmeric: {
    id: 16,
    name: 'Organic Turmeric Powder - Pure',
    image: 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=400&h=300&fit=crop',
  ...
  // Fresh Organic Fruits from Farm
  mangoes: {
    id: 18,
    name: 'Organic Mangoes - Farm Fresh',
...
export const getProductsByCategory = (category) => {
  return Object.values(productImages).filter(product => product.category === category)
}

// Helper function to get random products
export const getRandomProducts = (count = 6) => {
  const products = Object.values(productImages)
